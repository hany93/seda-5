  ...
  return (
    <AppBar className={classes.appBar + appBarClasses}>
      <Toolbar className={classes.container}>
        ...
        <Hidden smDown implementation="css">
          <AdminNavbarLinks color={color} municipios={props.municipios} setMunicipios={props.setMunicipios} setProvincias={props.setProvincias} provincias={props.provincias} setLugarfiltrado={props.setLugarfiltrado} />
        </Hidden>
        <Hidden mdUp implementation="css">
          <IconButton
            color="inherit"
